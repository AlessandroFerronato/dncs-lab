...
## Design Requirements
- Hosts 1-a and 1-b are in two subnets (*Hosts-A* and *Hosts-B*) that must be able to scale up to respectively 389 and 32 usable addresses
- Host 2-c is in a subnet (*Hub*) that needs to accommodate up to 69 usable addresses
...
1. The first is between the two routers, *router-1* and *router-2*, for which I've chosen the subnet 10.0.0.0/30 because it covers only the two routers (2<sup>32-30</sup>-2=2).
2. The second is between *host-a* and *router-1*, for this I used the subnet 192.168.0.0/23 because 389 different addresses are needed to be covered (2<sup>32-23</sup>-2>389).
3. The third is between *host-b* and *router-1*, so I used the subnet 192.168.2.0/26 to cover all the 32 addresses (2<sup>32-26</sup>-2>32).
4. The last on is between *host-c* and *router-2*, in this case I've chosen to use the subnet 192.168.4.0/25 to cover the 69 addresses (2<sup>32-25</sup>-2>69).
...
<p><span>Server&nbsp;name:</span> <span>ae7ebfd51ee7</span></p>
<p class="smaller"><span>Date:</span> <span>05/Dec/2020:20:11:29 +0000</span></p>
...
<div class="check"><input type="checkbox" id="check" onchange="changeCookie()"> Auto Refresh</div>
    <div id="footer">
        <div id="center" align="center">
            Request ID: 19b654588d35bc7948e3cc51964ab72c<br/>
            &copy; NGINX, Inc. 2018
        </div>
    </div>
</body>
